/*
 *  protocol_webservice_json.cpp
 *
 *  Created on: Nov 02, 2021
 *      Author: Alexandre Krzyzanovski - Pumatronix
 *
 *  ITSCAM Protocol to WebService REST JSON Plugin Example
 *
 */
...
#include "protocol_webservice_json.h"
...
int main(int argc, char *argv[])
{
    ...
    LOG_INFO << "ITSCAM Protocol to WebService JSON - Version " << PLUGIN_VERSION_MAJOR << "."
